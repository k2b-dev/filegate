...
The commands below install **v6.0.0**.
For ARM64 systems, replace `amd64` with `arm64` in both the URL and filename.

### Debian

```sh
curl -fLO https://github.com/k2b-dev/filegate/releases/download/v6.0.0/filegate_linux_amd64.deb
...
```sh
curl -fLO https://github.com/k2b-dev/filegate/releases/download/v6.0.0/filegate_linux_amd64.rpm
